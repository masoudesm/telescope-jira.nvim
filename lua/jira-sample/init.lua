		...
		.new(opts, {
			...
			attach_mappings = function(prompt_bufnr, map)
				local function open_issue()
					...
					vim.api.nvim_buf_set_lines(prompt_bufnr, 0, -1, false, vim.split(issue_details, "\n"))
					vim.api.nvim_buf_set_option(prompt_bufnr, "filetype", "markdown") -- Optional: Set syntax highlighting
				end
